...
list_zipped_files <- function(state_list,path_to_data){
  ...
  for(i in 1:length(state_list)){
    zipFiles[[i]] = list.files(path = paste0(path_to_data,lista_estado[[i]]),pattern = "*.zip",full.names = TRUE)
...
diretorios='D:\\Eduardo_Minsky\\SICAR\\09_22\\Estados\\'
lista_diretorios=list_zipped_files(lista_estado = list('Rondonia','Roraima','Santa Catarina','Sao Paulo','Sergipe','Tocantins'),caminho = diretorios)

unzip_files(lista_zip =lista_diretorios,caminho = diretorios,lista_estado = list('Rondonia','Roraima','Santa Catarina','Sao Paulo','Sergipe','Tocantins') )



lista_estado = list('Rondonia','Roraima','Santa Catarina','Sao Paulo','Sergipe','Tocantins')

lista_zipped_2=list()
for(i in 1:length(lista_estado)){
  lista_zipped_2[[i]]=list_zipped_files_2(estado =lista_estado[[i]],caminho = diretorios)
}
for(i in 1:length(lista_zipped_2)){
  unzip_shapes(shapes_estado = lista_zipped_2[[i]],caminho = diretorios,estado = lista_estado[[i]])
}
shape_lista=list()
estados=list('Sao Paulo','Sergipe','Tocantins')
nomes=list('CAR_Sao_Paulo_09_22','CAR_Sergipe_09_22','CAR_Tocantins_09_22')
for(i in 1:length(estados)){
  shape_lista[[i]]=reading_all_shapes(caminho = diretorios,estado = estados[[i]],type_file = 'AREA_IMOVEL',
                                      nome_layer_criado = nomes[[i]],diretorio_salvar='D:\\Eduardo_Minsky\\SICAR\\09_22\\ShapeFiles_CAR\\')
}
...
reading_all_shapes_ligth(caminho ='D:\\Eduardo_Minsky\\SICAR\\09_22\\Estados\\' ,estado='Tocantins',type_file='RESERVA_LEGAL.shp',caminho_save = 'D:\\Eduardo_Minsky\\SICAR\\09_22\\ShapeFile_RL\\')
